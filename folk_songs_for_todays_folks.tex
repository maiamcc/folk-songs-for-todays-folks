\documentclass[twoside,19pt,openany,letterpaper]{memoir}%
...
\song{Misc. Choruses}{}
% MAID OF AMSTERDAM%
\huge\textbf{Maid of Amsterdam (A-Rovin')}\vspace{10pt}
\large\textit{\textbf{trad. sea shanty, new version learned from Heather Wood}}\normalsize
\addcontentsline{toc}{section}{Maid of Amsterdam (A-Rovin')}
...
\huge\textbf{The Widow and the Devil}\vspace{10pt}
\large\textit{\textbf{by Mick Ryan (after The Poozies' version), add'l verses Maia McCormick}}\normalsize
\addcontentsline{toc}{section}{The Widow and the Devil}
\chorus{
